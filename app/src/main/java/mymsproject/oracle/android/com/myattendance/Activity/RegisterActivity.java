...
public class RegisterActivity extends AppCompatActivity {
  ...
  /*public void registerClick(View v) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mobileET = (EditText)findViewById(R.id.registerMobileNumber) ;
        addressET = (EditText)findViewById(R.id.registerAddress);
        departmentNameET = (EditText)findViewById(R.id.registerDepartmentName);
            ...
            try {
                ...
                if (Utility.isNotNull(name) && Utility.isNotNull(email) && Utility.isNotNull(password)) {
                    ...
                    if (Utility.validate(email)) {
                        ...
                        jsonParams.put("department", departmentName);
                        jsonParams.put("misc", "{}");

                        // Put Http parameter password with value of Password Edit View control
                        jsonParams.put("password", password);
                        //jsonParams.setUseJsonStreamer(true);
    ...
    public void invokeWS(JSONObject jsonParams){
        ...
        String url = "http://13.232.137.59:2000/students" ;
        Log.d("POST Url = ", "url" + url);
        Log.d("Request Params = ", "" + jsonParams);
